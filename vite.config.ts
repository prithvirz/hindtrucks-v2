...
export default defineConfig(({ mode }) => ({
  ...
  define: {
    ...
    'import.meta.env.VITE_FIREBASE_MESSAGING_VAPID_KEY': JSON.stringify(process.env.VITE_FIREBASE_MESSAGING_VAPID_KEY || ''),
    ...
    __VITE_APP_VERSION__: JSON.stringify(process.env.VITE_APP_VERSION || '0.0.0'),
    __VITE_API_MODE__: JSON.stringify(process.env.VITE_API_MODE || 'mock'),
    ...
    __VITE_FCM_VAPID_KEY__: JSON.stringify(process.env.VITE_FCM_VAPID_KEY || ''),
